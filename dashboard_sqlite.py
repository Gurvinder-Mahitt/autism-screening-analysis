...
dashboard_sqlite.py
--------------------
SQLite version of dashboard.py — same 4 charts + KPI row,
reads from the local ticket_shop.db file instead of MySQL.
...
st.markdown("---")
st.caption("Built with Python, MySQL / SQLite, Streamlit, and Plotly.")
